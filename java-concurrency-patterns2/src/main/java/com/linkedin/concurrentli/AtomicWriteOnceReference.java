 ...
 * synchronization-free(无同步).
 *
 * @param <T> the type of object being referenced.
 *
 * @Auther: viagra
 * @Date: 2019/11/14 17:04
 * @Description: https://github.com/linkedin/concurrentli.git
 */
public class AtomicWriteOnceReference<T> implements Serializable {
    ...
    public boolean trySet(T value) {
        ...
        // By using getFullyConstructed, we ensure that the value being fully written to memory
        // happens-before the reference in _obj is written, and hence before any possible read of _cacheObj. _cachedObj will thus either be null or
