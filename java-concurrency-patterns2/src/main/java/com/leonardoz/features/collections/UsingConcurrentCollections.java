package com.leonardoz.features.collections;
...
public class UsingConcurrentCollections {
    ...
    public static void usingConcurrentHashMap(){
        ...
        ConcurrentMap<UUID, Integer> valuesPerUuid = new ConcurrentHashMap<UUID,Integer>();
        // atomic operations
    ...
    public static void usingBlockingQueue() {
        ...
        // Multiple producer - Examples using simple threads this time
