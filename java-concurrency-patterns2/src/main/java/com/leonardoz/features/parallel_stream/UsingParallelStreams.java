package com.leonardoz.features.parallel_stream;
...
public class UsingParallelStreams {
    ...
    public static void main(String[] args) {
        ...
        IntStream.rangeClosed(0, 30_000)
                .parallel().mapToObj(BigInteger::valueOf).map(UsingParallelStreams::isPrime) // Int
    ...
    private static void dummyPerformanceCheck() {
        ...
        IntStream.rangeClosed(0,50_000).mapToObj(BigInteger::valueOf)
